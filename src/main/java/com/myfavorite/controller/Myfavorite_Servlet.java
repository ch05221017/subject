...
@WebServlet("/Myfavorite_Servlet")
public class Myfavorite_Servlet extends HttpServlet {
	/**
	 * 
	 */
...
//		}
		...
		if ("delete".equals(action)) { // 來自listAllEmp.jsp 或  /dept/listEmps_ByDeptno.jsp的請求
			...
			String requestURL = req.getParameter("requestURL"); // 送出刪除的來源網頁路徑: 可能為【/emp/listAllEmp.jsp】 或  【/dept/listEmps_ByDeptno.jsp】 或 【 /dept/listAllDept.jsp】
				...
				/***************************1.接收請求參數***************************************/
				Integer my_favorite_number = Integer.valueOf(req.getParameter("my_favorite_number"));
				System.out.println(my_favorite_number);
				
				/***************************2.開始刪除資料***************************************/
				Myfavorite_Service Myfavorite_Service = new Myfavorite_Service();
				Myfavorite_VO Myfavorite_VO = Myfavorite_Service.getOneEmp(my_favorite_number);
				Myfavorite_Service.DELETE(my_favorite_number);
