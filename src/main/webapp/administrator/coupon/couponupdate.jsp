...
<table>
	<tr>
		<td>優惠劵編號<font color=red><b></b></font></td>
		<td><%=couponjspVO.getCouponserialnumber()%></td>
	</tr>
	
	<tr>
		<td>優惠券名稱<font color=red><b></b></font></td>
		<td><input type="TEXT" name="couponname" size="45" value="<%=couponjspVO.getCouponname()%>" /></td>		
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input name="enddate" id="f_date2" type="text" size="45"></td>		
	</tr>
	<tr>
		<td>回饋數<font color=red><b></b></font></td>
		<td><input type="TEXT" name="refundpercent"  size="45" value="<%=couponjspVO.getRefundpercent()%>" /></td>
...
<input type="hidden" name="couponserialnumber" value="<%=couponjspVO.getCouponserialnumber()%>">
