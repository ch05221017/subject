...
<%--                           <td><input type="TEXT" name="admno" size="45" value="${user.admname}" /></td> --%>
                        ...
                        <tr>
                          <td>內容</td>
                          <td><input type="TEXT" name="froanndesc"  size="45"
                             value=" " /></td>
                        </tr>
                        <tr>
                          <td>開始日期</td>
                        ...
                        <tr>
<!--                           <td>上架狀態</td> -->
<!--                           <td><input type="TEXT" name="froannstatus" size="45" value="" /></td> -->
                        <td>上架狀態<font color=red><b></b></font></td>
						<td>
						<label><input name="froannstatus" type="radio" value="0" checked='checked'><font size="5"> off</font></label>
						<span>&nbsp&nbsp</span>
						<label><input name="froannstatus" type="radio" value="1" ><font size="5"> on</font></label>
                        </td>  
                        </tr>
