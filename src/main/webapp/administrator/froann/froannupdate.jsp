          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<%=request.getContextPath()%>/administrator/froann.jsp" class="nav-link active">
                      <i class="far fa-circle nav-icon "></i>
                      <p>首頁公告</p>
                    </a>
                  </li>
...
<table>
	...
	<tr>
		<td>維護人<font color=red><b></b></font></td>
		<td>${user.admname}</td>
<%-- 		<td><input type="TEXT" name="admno" size="45" value="${user.admname}" /></td> --%>
<%-- 		<td>${froannVO.admno}</td> --%>
	</tr>
	<tr>
		<td>內容<font color=red><b></b></font></td>
		<td><input type="TEXT" name="froanndesc" size="45" value="<%=froannVO.getFroanndesc()%>" /></td>		
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input name="froannedate" id="f_date2" type="text" size="45"></td>		
	</tr>
	<tr>
		<td>上架狀態<font color=red><b></b></font></td>
		<td>
		<label><input name="froannstatus" type="radio" value="0" ${froannVO.froannstatus eq 0 ? "checked='checked'": ""}><font size="5"> off</font></label>
		<span>&nbsp&nbsp</span>
		<label><input name="froannstatus" type="radio" value="1" ${froannVO.froannstatus eq 1 ? "checked='checked'": ""}><font size="5"> on</font></label>
...
<input type="hidden" name="froannno" value="<%=froannVO.getFroannno()%>">
<input type="hidden" name="admno" value="${user.admname}">
