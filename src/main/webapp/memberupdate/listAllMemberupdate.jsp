...
<%
    ...
    List<MemberupdateVO> memberupdatelist = memberupdateSvc.getAll();
    pageContext.setAttribute("memberupdatelist",memberupdatelist);
%>
...
<head>
    ...
    <!--自然改-->
    <!-- Css Styles -->
    <link rel="stylesheet" href="memberupdatehtml/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/jquery-ui.min.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="memberupdatehtml/css/style.css" type="text/css">
...
<%-- 	<%@ include file="page1.file" %>  --%>
	<br>
	<c:forEach var="memberupdateVO" items="${memberupdatelist}"  begin="${offset}" end="<%=memberupdatelist.size()%>">
		 <c:if test="${memID == memberupdateVO.memberserialnumber}">
		<tr>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/memberupdate/memberupdate.do" style="margin-bottom: 0px;">
			     <input type="submit" value="修改">
			     <input type="hidden" name="memberserialnumber"  value="${memberupdateVO.memberserialnumber}">
