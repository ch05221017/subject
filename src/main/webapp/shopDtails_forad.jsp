        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                 ...
                 <img id="img_content" src="<%=request.getContextPath()%>/Item_Servlet?action=VOUpdate&No=${Item_VO.item_serial_number}"  name="action"  alt="No Image" style="width:100%;height:450px" />       
         </div>
